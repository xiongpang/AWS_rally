...
#esrally --pipeline benchmark-only --track-path=~/.rally/benchmarks/tracks/tutorial  --target-host=https://search-yuela-qvdrihvj6rlxac7dbqf2d7qelm.us-west-1.es.amazonaws.com:443 --client-options="use_ssl:true, verify_certs:true,region:'us-west-1',amazon_aws_log_in:'os_environment'" --test-mode
